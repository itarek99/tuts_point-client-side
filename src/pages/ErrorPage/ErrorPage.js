  ...
  return (
    <div class='grid h-screen place-content-center bg-white'>
      <div class='text-center'>
        ...
        <h1 class='text-2xl font-bold tracking-tight text-gray-900 sm:text-4xl'>PAGE NOT FOUND</h1>

        <p class='mt-4 text-gray-500'>Looks like this page went on vacation!</p>
